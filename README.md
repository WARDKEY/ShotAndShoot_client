...
### 폐기물 대행 업체 찾기 기능
- 폐기물 업체 페이지에서 지도에서 사용자 위치를 기반으로 주변의 폐기물 대행 업체 업체 찾기
- 메인 페이지에서 사용자 위치와 가장 가까운 폐기물 대행 업체를 표시
- 특정 폐기물 업체 상세 정보를 확인하고 전화번호 클릭 시 전화걸기

### 커뮤니티 기능
- 제목, 내용, 카테고리를 입력 및 선택하여 게시글 작성
- 게시글 삭제 버튼을 통해 게시글 삭제
- 인기 순으로 게시글을 나타내는 기능
- 게시글 상세화면에 댓글 작성 및 조회
- 댓글 삭제 버튼을 통해 댓글 삭제
